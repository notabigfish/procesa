...
class TripletLossV4(nn.Module):
    def __init__(self, loss_weight=1.0):
        super(TripletLossV4, self).__init__()
    ...
    def get_unsupervised_losses(self, outp1, anchor_f, labels):
        ...
        anc_neg3 = torch.mm(anchor_out, f1.T)
        anc_neg3 = anc_neg3 / factor
        ...
        loss =  loss_pos + loss_neg1 + loss_neg3
        return loss
