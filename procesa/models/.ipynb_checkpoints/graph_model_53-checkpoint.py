...
class GraphModel53(GraphModel21):
    def __init__(self, **kwargs):
        super(GraphModel53, self).__init__(**kwargs)
    ...
    def extract_feat(self, graphs):
        ...
        graphs.ndata['hr'] = self.ln1(self.relu(self.conv1(graphs, node_in='h', edge_in='dr', feat_out='hr')))
        graphs.ndata['hr'] = self.ln2(self.relu(self.conv2(graphs, node_in='hr', edge_in='dr', feat_out='hr')))
