...
class GraphModel52(GraphModel21):
    def __init__(self, **kwargs):
        super(GraphModel52, self).__init__(**kwargs)
    ...
    def extract_feat(self, graphs):
        ...
        graphs.ndata['h'] = self.ln1(self.relu(self.conv1(graphs, node_in='h', edge_in='dr', feat_out='h')))
        graphs.ndata['h'] = self.ln2(self.relu(self.conv2(graphs, node_in='h', edge_in='dr', feat_out='h')))
